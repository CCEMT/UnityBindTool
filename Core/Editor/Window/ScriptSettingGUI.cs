...
namespace BindTool
{
    public partial class BindWindow
    {
        ...
        private Vector2 methodScrollPosition1;
        private Vector2 methodScrollPosition2;
        ...
        void TemplateGenerate()
        {
            ...
            GUILayout.BeginVertical("box");
            methodScrollPosition1 = EditorGUILayout.BeginScrollView(methodScrollPosition1, false, false, GUILayout.Width(230), GUILayout.Height(160));

            for (int i = selectVariableAmount - 1; i >= 0; i--)
            {
                GUILayout.BeginVertical("frameBox");
                VariableData variable = selectVariableDataList[i];
                ...
                GUI.color = Color.white;
                if (GUILayout.Button(variable.varialbleName))
                {
                    GenericMenu menu = new GenericMenu(); //初始化GenericMenu 
            ...
            GUILayout.BeginVertical("box");
            methodScrollPosition2 = EditorGUILayout.BeginScrollView(methodScrollPosition2, false, false, GUILayout.Width(230), GUILayout.Height(160));

            for (int i = selectTemplateAmount - 1; i >= 0; i--)
            {
                GUILayout.BeginVertical("frameBox");
                TemplateData templateData = selectTemplateDataList[i];
