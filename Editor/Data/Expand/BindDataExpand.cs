...
namespace UnityBindTool
{
    ...
    {
        public static T GetBindInfo<T>(this BindData bindData) where T : IBindInfo
        {
            int amount = bindData.bindInfos.Count;
            for (int i = 0; i < amount; i++)
            {
                IBindInfo bindInfo = bindData.bindInfos[i];
        ...
        public static void SetBindInfo<T>(this BindData bindData) where T : IBindInfo
        {
